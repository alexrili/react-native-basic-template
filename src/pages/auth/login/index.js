            ...
            <KeyboardAvoidingView
                ...
                <ScrollView>
                    <Form>
                        ...
                        <Input error={errors.email} autoCapitalize="none"
                               placeholder={translate('auth.login.form.username')} onChangeText={setUsername}/>
                        <Input error={errors.password} placeholder={translate('auth.login.form.password')} password
                               onChangeText={setPassword}/>
                        <Button loading={loading} onPress={login}>{translate('auth.login.form.button')}</Button>
                        <LinkText onPress={() => {
                            navigation.navigate('Register');
                        }}>{translate('auth.login.registerLink')}</LinkText>
                        <LinkText onPress={() => {
                            navigation.navigate('ForgetPassword');
                        }}>{translate('auth.login.forgotPasswordLink')}</LinkText>
                    </Form>
                </ScrollView>
            </KeyboardAvoidingView>
        </Container>
